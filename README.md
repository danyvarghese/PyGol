...
```cmd
Dany Varghese and  Alireza Tamaddoni-Nezhad, Towards Automated Data Science using Meta Inverse Entailment,  
In Proceedings of the 31st International Conference on ILP, Springer, 2022(under review).
```
