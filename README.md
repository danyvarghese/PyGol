...
**PyGol** is free to use for non-commercial research and education. If you use ILASP for research, we ask you to use this [citation](https://github.com/danyvarghese/citation/blob/main/pygol.bib) and relevant papers. Anyone wishing to use PyGol for commercial purposes should contact Dany Varghese(dany.varghese@surrey.ac.uk).
